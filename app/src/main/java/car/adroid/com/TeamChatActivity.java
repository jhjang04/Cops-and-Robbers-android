...
//                layout.setFocusable(!hasFocus);
        ...
        // hide keyboard when touching listview
        findViewById(R.id.lvTeamChat).setOnTouchListener(new View.OnTouchListener(){
            @Override
        ...
        findViewById(R.id.loTeamChat).setOnTouchListener(new View.OnTouchListener(){
            @Override
            public boolean onTouch(View view, MotionEvent motionEvent) {
                InputMethodManager imm = (InputMethodManager) getSystemService(INPUT_METHOD_SERVICE);
                imm.hideSoftInputFromWindow(getCurrentFocus().getWindowToken(), 0);
...
//        });
            ...
            new ProgressThread(mContext){
                ...
                public void run() {
                    try {
                        ...
                        JSONObject response = new HttpConnector().sendChat(data.getRoomId() , data.getTeam() , data.getTeam() , data.getUserNo() , data.getNickName() , text , data.getLastChatIdx() , data.getLastTeamChatIdx());
    ...
    public void refreshScreen(){
        ...
        AppData data = AppData.getInstance(getApplicationContext());
        ArrayList<ChatMessage> chatList = data.getTeamChatList();
